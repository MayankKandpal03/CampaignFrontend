          ...
          <div style={{
            ...
            {notifPermission !== "denied" && (
              <button
                ...
                style={{ padding: "6px 16px", borderRadius: 4, border: `1px solid ${T.amber}`, background: "transparent", color: T.amber, fontSize: 11, fontWeight: 600, cursor: "pointer", fontFamily: "'Cinzel',serif", letterSpacing: "0.1em", whiteSpace: "nowrap", transition: "all 0.15s ease" }}
          ...
          <div style={{ padding: pad, flex: 1, overflowY: "auto" }}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: isMobile ? "1fr" : "1fr 1fr", gap: 24, alignItems: "start" }}>
              ...
              <div style={{ background: T.bgCard, border: `1px solid ${T.subtle}`, borderRadius: 10, padding: "24px 22px", boxShadow: "0 2px 12px rgba(0,0,0,0.3)" }}>
                ...
                {taskError && (
                  <div style={{ padding: "10px 14px", borderRadius: 8, marginBottom: 16, background: T.redBg, border: `1px solid ${T.red}44`, color: T.red, fontSize: 12 }}>{taskError}</div>
                )}
                {taskOk && (
